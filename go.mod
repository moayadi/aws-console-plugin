module github.com/moayadi/aws-console-plugin
...
require (
	...
	github.com/hashicorp/eventlogger v0.2.3 // indirect
	...
	github.com/hashicorp/go-kms-wrapping/wrappers/transit/v2 v2.0.8 // indirect
