...
func secretAccessKeys(b *backend) *framework.Secret {
	return &framework.Secret{
		...
		Fields: map[string]*framework.FieldSchema{
			...
			"console_login": {
				Type:        framework.TypeString,
				Description: "AWS Console Login",
			},
			"console_duration": {
				Type:        framework.TypeString,
				Description: "AWS Console Login TTL",
			},
		},
...
func (b *backend) assumeRole(ctx context.Context, s logical.Storage,
	...
	if consoleLogin {
		...
		console_url = genConsoleUrl(tokenResp, consoleDuration)
		// log.Print(console_url)
	}
...
func genConsoleUrl(creds *sts.AssumeRoleOutput, sessionDuration string) string {
	...
	err = json.Unmarshal([]byte(body), &token) // here!
	...
	requestParameters += "&Issuer=" + url.QueryEscape("Example.com")
	...
	return federationEndpoint + requestParameters
